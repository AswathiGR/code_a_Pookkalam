...
def earth(x,y):
    p1=point(x=x+10, y=y+10)
    p2=point(x=x+5, y=y+5)
    p3=point(x=x-2, y=0)
    p4=point(x=x+5, y=y-5)
    p5=point(x=x+20, y=0)
    c1=circle(r=25,x=x,y=y,fill="red",stroke="none")
    c2=circle(r=15,x=x+5,y=y+7,fill="blue",stroke="none")
    c3=circle(r=15,x=x+5,y=y+5,fill="green",stroke="none")
    continents=polygon(([p1,p2,p3,p4,p5]),fill='wheat',stroke='none')
    continents1=continents|translate(x=0,y=0)
...
show(c1,mainc,flow,semi,lpetal, donut,upetal,flow1,poly,greencir,donut1,c16,ellipflower,c4,c0,hai,z,y,m,d1,z1,y1)
