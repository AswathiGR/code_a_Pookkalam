...
mid=combine([c1,c2,c3,c7,c8,c9,c10])

#inner circles  #F8485E#ff3399
...
#dots
dot = circle(r=5,fill="wheat",stroke="none")
d1 = dot | translate(x=145,y=0)| repeat(20,rotate(20))
dr = dot | translate(x=40,y=0)| repeat(20,rotate(30))
...
codeline=combine([code1,code2])

show(c1,mainc,flow,semi,shape2, donut,shape,flow1,sidec1,sidec2,poly,greencir,donut1,c16,ellipflower,c4,c0,z,y,m,d1,z1,m1,y1)
